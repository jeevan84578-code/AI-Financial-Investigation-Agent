...
import { AlertTriangle, ArrowUpRight, BarChart3, PieChart as PieChartIcon, ShieldAlert, TrendingUp } from "lucide-react";
import {
  Bar,
  BarChart,
  CartesianGrid,
